...
| **sprintf()**              | [Link](https://www.php.net/manual/ru/function.sprintf.php) | Возвращает отформатированную строку                                                                |
...
| **str_replace()**          | [Link](https://www.php.net/manual/ru/function.str-replace.php) | Заменяет все вхождения строки поиска на строку замены |
